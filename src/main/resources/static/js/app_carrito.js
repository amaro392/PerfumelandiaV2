const API_URL = "http://192.168.2.103:8080/api/v2/carrito";
...
async function eliminarDelCarrito(id) {
  try{
    ...
    alert("Producto Eliminado");
      fetch("http://192.168.2.103:8080/api/v2/notificaciones/agregar", {
        method: "POST",
...
function confirmarCompra() {
  fetch("http://192.168.2.103:8080/api/v2/carrito/confirmar", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
  })
  .then(res => res.text())
...
function cargarCarrito() {
      fetch("http://192.168.2.103:8080/api/v2/carrito")
        .then(res => res.json())
        .then(data => {
